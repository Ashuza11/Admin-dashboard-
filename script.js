const body = document.querySelector("body"), modeToggle = document.querySelector(".mode-toggle"),
    sidbar = document.querySelector("nav"), sidbarToggle = document.querySelector(".sidbar-toggle");
